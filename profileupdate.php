                ...
                <div class="container">
                    <main>
                        <div class="py-5 text-center mt-4">
                            <img class="d-block mx-auto mb-4 mt-2" src="/sr/assets/brand/person-circle.svg" alt=""
                                width="72" height="57">
                        ...
                        <div class="row g-5">
                            <div class="col-md-12">
                                <h4 class="mb-3">Student Details Update</h4>
                                <form
...
?>
                                        ...
                                        <div class="col-sm-6">
                                            <label for="state" class="form-label">State</label><span style="color:red">
                                                *</span>
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-sm-6">
                                            <label for="city" class="form-label">City</label><span style="color:red">
                                                *</span>
